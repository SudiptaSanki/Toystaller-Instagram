...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Toystaller-Instagram.git
   ```
3. Load the unpacked extension into Chrome (`chrome://extensions/` ➔ Developer Mode ➔ Load Unpacked).
4. Make your code changes and test directly on Instagram.
